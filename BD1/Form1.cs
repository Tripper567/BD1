    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonZap1_Click(object sender, EventArgs e)
        {
            ...
            gridZapros1.DataSource = db.ReturnTable(
                ...
                $"AND Заказ.Дата_заказа > {GetSQLFormatDate(dateTimePickerZap1.Value)} " +
                $"AND Заказ.Дата_заказа < {GetSQLFormatDate(dateTimePickerZap2.Value)}").Tables[0].DefaultView;
        }
